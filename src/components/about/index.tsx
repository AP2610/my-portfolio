  ...
  return (
    <Section className="space-y-8">
      ...
      <p>
        ...
        ensuring that both user experience and technical execution are of the highest quality. Having lived in{' '}
        <TextHighlight color="blue">Australia, India, Kenya, Switzerland, and now the Netherlands</TextHighlight>, I excel at
        navigating cultural dynamics and seamlessly integrating into diverse teams.
      </p>
      ...
      <p>
        While some pride themselves on complex solutions, I value clarity and simplicity in code. I often find myself breaking
        down complex structures into more readable, maintainable, and efficient solutions. A well-structured, simple codebase
        improves both productivity and collaboration. Having said that, I myself have written some overly complex logic in the
        past, only to find myself returning months later trying to demystify it. That&apos;s only reinforced my belief in KISS -
      ...
      <p>
        I have worked extensively with large-scale codebases, particularly at the Corona Dashboard and Blokker. I am a strong
        advocate for refactoring—a clean, well-structured codebase is paramount to long-term productivity and maintainability.
        However, I also understand the balance between code quality and efficient delivery. Like my mother taught me, &quot;a
        clean closet makes for a clear mind.&quot;
      </p>
