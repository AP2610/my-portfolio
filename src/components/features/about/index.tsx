    ...
    <article className="space-y-8">
      ...
      <div className="space-y-4 text-foreground">
        ...
        <p>
          ...
          cross-timezone teamwork. While I appreciate the autonomy and trust required for remote work, I'm also happy to return to
          a hybrid environment. Having said that, my preference is for mostly remote work.
        </p>

        <h3 className="!mt-8 text-xl">AI in My Workflow</h3>
        ...
        <h3 className="!mt-8 text-xl">Beauty in Simplicity</h3>
        ...
        <h3 className="!mt-8 text-xl">Experience with Large Codebases & Clean Code Philosophy</h3>

        <p>
          I have experience with large-scale codebases, particularly at the Corona Dashboard and Blokker. I am a strong advocate
