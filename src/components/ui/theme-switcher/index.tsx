...
export const ThemeSwitcher = ({ className }: { className?: string }) => {
  ...
  const classes = clsx(
    'flex w-[var(--switchWidth)] h-5 cursor-pointer items-center rounded-full bg-cosmic-latte-700/30 outline outline-2 outline-cosmic-latte-700 dark:bg-rich-black-400/30 dark:outline-rich-black-400 hover:bg-cosmic-latte-600/60 dark:hover:bg-rich-black-400/60 transition-colors duration-300',
