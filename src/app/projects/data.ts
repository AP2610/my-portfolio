...
export type ProfessionalProjectType = BaseProjectType & {
  type: 'professional';
  role: string;
  situation: string;
  tasks: string[];
...
export type PersonalProjectType = BaseProjectType & {
  type: 'personal';
  description: string;
};
...
export const projectsData: {
  professionalProjects: ProfessionalProjectType[];
  ...
  professionalProjects: [
    {
      ...
      name: 'Capacare',
      image: '/project-images/capacare.png',
      websiteUrl: 'https://www.capacare.org/',
      additionalInfo:
      ...
      technologies: ['Agile', 'JavaScript', 'React', 'TailwindCSS', 'TypeScript', 'Git', 'NextJS', 'Sanity', 'Scrum'],
    },
    {
      type: 'professional',
      ...
      technologies: ['Vue.js', 'Nuxt.js', 'JavaScript', 'TypeScript', 'CSS', 'SCSS', 'Strapi', 'Git', 'Scrum'],
    },
    {
      type: 'professional',
      role: 'Frontend Engineer',
      name: 'Ministry of Health, Wellness, and Sport',
    ...
    },
    {
      ...
      technologies: ['Agile', 'AJAX', 'JavaScript', 'HTML 5', 'CSS', 'SCSS', 'Git', 'Cypress', 'Bootstrap', 'jQuery', 'Scrum'],
    },
    {
      type: 'professional',
      role: 'Frontend Engineer',
  ...
  personalProjects: [
    {
      type: 'personal',
      name: 'URL Shortener',
      description: 'A URL shortener built with Next.js, Tailwind CSS, TypeScript.',
      technologies: ['Next.js', 'Tailwind CSS', 'TypeScript', 'Prisma', 'Motion', 'Zustand', 'ClerkAuth'],
      githubUrl: 'https://github.com/AP2610/url-shortener',
      websiteUrl: 'https://www.shortly-it.xyz/',
      image: '/project-images/shortly.png',
    },
    {
      type: 'personal',
      name: 'Pong',
      ...
      technologies: ['HTML', 'CSS', 'TypeScript', 'Canvas'],
      githubUrl: 'https://github.com/AP2610/pong',
      websiteUrl: 'https://pong-five-dusky.vercel.app/',
      image: '/project-images/pong.png',
    },
    {
      type: 'personal',
      name: 'Next Starter App',
      description:
        "A Next.js starter template designed to help me get up and running quickly with all the essential tools and configurations pre-setup. All you have to do is run npx create-next-starter-app-template and you're good to go!",
      technologies: ['Next.js', 'Tailwind CSS', 'TypeScript'],
      githubUrl: 'https://github.com/AP2610/next-starter-app',
    },
    {
      type: 'personal',
      name: 'Next Starter App Monorepo',
      description:
        'A monorepo setup leveraging my next-starter-app. The motivation behind this was to get familiar with monorepo tooling, specifically Turborepo. It contains packages for Jest, Typescript Configs, Eslint configs, and Tailwind config. I intend to use it to learn more about microfrontend architectures.',
      technologies: ['Next.js', 'Tailwind CSS', 'TypeScript', 'Turborepo', 'Jest', 'Eslint', 'Typescript'],
      githubUrl: 'https://github.com/AP2610/next-starter-app-monorepo',
    },
  ],
};
